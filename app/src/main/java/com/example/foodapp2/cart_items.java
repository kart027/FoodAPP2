...
public class cart_items extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS Restruant1(name VARCHAR,quantity number,Time VARCHAR);");
        cartData = Cart.getCartData();

        timePicker = (TimePicker) findViewById(R.id.timepicker);
        b = (Button) findViewById(R.id.orderbtn);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(cart_items.this, "Orders placed", Toast.LENGTH_SHORT).show();
    ...
    public double calcTotalCost() {
        ...
        double afterfortypercent = totalCost*40/100;
        totalCost = totalCost - afterfortypercent;


        return afterfortypercent;
    ...
    public void addCartItemCard(View v, CartItem cartItem) {
        ...
        db.execSQL("INSERT INTO Restruant1 VALUES('"+name+"','"+quantity+
